...
public class Groupe {
    ...
    /**
     *
     * @return true si les proprietés du groupe on le même proprietaire sinon faux
     */
    public boolean memeProprietaire(){
        boolean resultat = true;       
        int i =0;        
        Joueur jProprio = proprietes.get(i).getProprietaire() ; // jProprio est eguale au proprietaire de la première proprieté
        i++;
        // tant que le proprietaire de i- et le même que le proprietaire à i ET i < au nbr de proprietes
        while(resultat && i < proprietes.size()){
            ...
            jProprio = proprietes.get(i).getProprietaire() ; // jProprio jProprio est eguale au proprietaire de la i ème proprieté
            i++;
        }
        return resultat;
    }
